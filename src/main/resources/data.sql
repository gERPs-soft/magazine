...
INSERT INTO products(id, assort_index, name, product_group_id, PKWiU, unit_of_masure, barcode, weight_unit, package_unit_id, number_in_package, height, weight, length, number_in_pallet, supplier_id, stock, price_last_supply, vat)
VALUES
(1, '1.02.003', 'Ręczniki PREMIUM 4000 biale', 2, '', 'szt', '112200445511', 8.2, 1, 1, 50, 40, 60, 32, 1, 320, 49, 'VAT_23'),
(2, '1.07.001', 'Papier PROFIT Flesz 2w bialy', 1, '', 'szt', '112200444412', 4.0, 2, 12, 20, 40, 60, 720, 2, 2400, 2.5, 'VAT_23');
