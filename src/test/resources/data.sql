...
INSERT INTO products(assort_index, name, product_group_id, unit_of_masure, barcode, weight_unit, package_unit, number_in_package, height, weight, length, number_in_pallet, supplier_id, stock, price, vat)
VALUES
